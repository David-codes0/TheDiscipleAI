...
import 'question_component_alphabet_v_model.dart';
export 'question_component_alphabet_v_model.dart';

class QuestionComponentAlphabetVWidget extends StatefulWidget {
  const QuestionComponentAlphabetVWidget({
    super.key,
  ...
  @override
  State<QuestionComponentAlphabetVWidget> createState() =>
      _QuestionComponentAlphabetVWidgetState();
}

class _QuestionComponentAlphabetVWidgetState
    extends State<QuestionComponentAlphabetVWidget> {
  late QuestionComponentAlphabetVModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuestionComponentAlphabetVModel());
  }
          ...
          Row(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Text(
                    functions.oppostiteQuestionEditor(
